...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    if (payload.texture)
    {
        ...
        return_color =       //use getColor function to get the color from texture.
    ...
    for (auto& light : lights)
    {
        ...
        // Light Direction
        Eigen::Vector3f light_dir =        //remember to normalize
        // View Direction
        Eigen::Vector3f view_dir =       //remember to normalize
        // Half Vector
        Eigen::Vector3f h =       //remember to normalize
        // Light Attenuation
