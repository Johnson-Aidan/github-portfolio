...
public class PlayerTest {
    ...
    public static void whoWins(Player.Hand p1Choice, Player.Hand p2Choice, Player p1, Player p2) {
        if (p1Choice == p2Choice) {
            ...
            Player.gameDraw();
        } else if ((p1Choice == Player.Hand.ROCK && p2Choice == Player.Hand.SCISSORS)
                || (p1Choice == Player.Hand.SCISSORS && p2Choice == Player.Hand.PAPER)
                || (p1Choice == Player.Hand.PAPER && p2Choice == Player.Hand.ROCK)) {
